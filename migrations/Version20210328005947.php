 ...
 */
final class Version20210328005947 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__face AS SELECT "index", card_id, artist_id, image_url, name, type_line, oracle_text, printed_text, power, toughness, image_local FROM face');
        ...
        $this->addSql('INSERT INTO face (face_index, card_id, artist_id, image_url, name, type_line, oracle_text, printed_text, power, toughness, image_local) SELECT "index", card_id, artist_id, image_url, name, type_line, oracle_text, printed_text, power, toughness, image_local FROM __temp__face');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE face');
        $this->addSql('CREATE TABLE face (card_id VARCHAR(36) NOT NULL, "index" INTEGER NOT NULL, artist_id VARCHAR(255) DEFAULT NULL, image_url VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, type_line VARCHAR(100) NOT NULL, oracle_text VARCHAR(2000) DEFAULT NULL, printed_text VARCHAR(2000) DEFAULT NULL, power VARCHAR(5) DEFAULT NULL, toughness VARCHAR(5) DEFAULT NULL, image_local VARCHAR(255) DEFAULT NULL, PRIMARY KEY(card_id, "index"))');
        $this->addSql('INSERT INTO face ("index", card_id, artist_id, image_url, name, type_line, oracle_text, printed_text, power, toughness, image_local) SELECT face_index, card_id, artist_id, image_url, name, type_line, oracle_text, printed_text, power, toughness, image_local FROM __temp__face');
        $this->addSql('DROP TABLE __temp__face');
        $this->addSql('CREATE INDEX IDX_5147B674ACC9A20 ON face (card_id)');
        $this->addSql('CREATE INDEX IDX_5147B67B7970CF8 ON face (artist_id)');
        $this->addSql('DROP INDEX IDX_AE2D486A4ACC9A2048086782');
