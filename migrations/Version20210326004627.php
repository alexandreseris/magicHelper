 ...
 */
final class Version20210326004627 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE rarity (name VARCHAR(50) NOT NULL, description VARCHAR(255) DEFAULT NULL, index_value INTEGER DEFAULT NULL, PRIMARY KEY(name))');
