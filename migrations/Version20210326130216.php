 ...
 */
final class Version20210326130216 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE setOfCard (code VARCHAR(10) NOT NULL COLLATE BINARY, name VARCHAR(100) NOT NULL COLLATE BINARY, released_date DATE DEFAULT NULL, setType_id VARCHAR(50) NOT NULL COLLATE BINARY, PRIMARY KEY(code), CONSTRAINT FK_D01563FC5787671D FOREIGN KEY (setType_id) REFERENCES set_type (code) NOT DEFERRABLE INITIALLY IMMEDIATE)');
