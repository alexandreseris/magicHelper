 ...
 */
final class Version20210404150356 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__face AS SELECT card_id, face_index, artist_id, image_url, name, type_line, oracle_text, printed_text, image_local, power_value, toughness_value FROM face');
        $this->addSql('DROP TABLE face');
        $this->addSql('CREATE TABLE face (face_id VARCHAR(40) NOT NULL, card_id VARCHAR(36) NOT NULL COLLATE BINARY, artist_id VARCHAR(255) DEFAULT NULL COLLATE BINARY, face_index INTEGER NOT NULL, image_url VARCHAR(255) DEFAULT NULL COLLATE BINARY, name VARCHAR(255) NOT NULL COLLATE BINARY, type_line VARCHAR(100) NOT NULL COLLATE BINARY, oracle_text VARCHAR(2000) DEFAULT NULL COLLATE BINARY, printed_text VARCHAR(2000) DEFAULT NULL COLLATE BINARY, image_local VARCHAR(255) DEFAULT NULL COLLATE BINARY, power_value VARCHAR(5) DEFAULT NULL COLLATE BINARY, toughness_value VARCHAR(5) DEFAULT NULL COLLATE BINARY, PRIMARY KEY(face_id), CONSTRAINT FK_5147B674ACC9A20 FOREIGN KEY (card_id) REFERENCES card (id_scryfall) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5147B67B7970CF8 FOREIGN KEY (artist_id) REFERENCES artist (name) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO face (card_id, face_index, artist_id, image_url, name, type_line, oracle_text, printed_text, image_local, power_value, toughness_value) SELECT card_id, face_index, artist_id, image_url, name, type_line, oracle_text, printed_text, image_local, power_value, toughness_value FROM __temp__face');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__face_color AS SELECT color_id FROM face_color');
        $this->addSql('DROP TABLE face_color');
        $this->addSql('CREATE TABLE face_color (color_id VARCHAR(1) NOT NULL COLLATE BINARY, face_id VARCHAR(40) NOT NULL, PRIMARY KEY(face_id, color_id), CONSTRAINT FK_AE2D486AFDC86CD0 FOREIGN KEY (face_id) REFERENCES face (face_id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_AE2D486A7ADA1FB5 FOREIGN KEY (color_id) REFERENCES color (code) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO face_color (color_id) SELECT color_id FROM __temp__face_color');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE face_manaCost (card_id VARCHAR(36) NOT NULL COLLATE BINARY, face_index INTEGER NOT NULL, symbol_id VARCHAR(20) NOT NULL COLLATE BINARY, PRIMARY KEY(card_id, face_index, symbol_id))');
        ...
        $this->addSql('DROP INDEX IDX_5147B674ACC9A20');
        $this->addSql('DROP INDEX IDX_5147B67B7970CF8');
        $this->addSql('CREATE TEMPORARY TABLE __temp__face AS SELECT card_id, artist_id, face_index, image_url, name, type_line, oracle_text, printed_text, power_value, toughness_value, image_local FROM face');
        $this->addSql('DROP TABLE face');
        $this->addSql('CREATE TABLE face (card_id VARCHAR(36) NOT NULL, face_index INTEGER NOT NULL, artist_id VARCHAR(255) DEFAULT NULL, image_url VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, type_line VARCHAR(100) NOT NULL, oracle_text VARCHAR(2000) DEFAULT NULL, printed_text VARCHAR(2000) DEFAULT NULL, power_value VARCHAR(5) DEFAULT NULL, toughness_value VARCHAR(5) DEFAULT NULL, image_local VARCHAR(255) DEFAULT NULL, PRIMARY KEY(card_id, face_index))');
        $this->addSql('INSERT INTO face (card_id, artist_id, face_index, image_url, name, type_line, oracle_text, printed_text, power_value, toughness_value, image_local) SELECT card_id, artist_id, face_index, image_url, name, type_line, oracle_text, printed_text, power_value, toughness_value, image_local FROM __temp__face');
        $this->addSql('DROP TABLE __temp__face');
        $this->addSql('CREATE INDEX IDX_5147B674ACC9A20 ON face (card_id)');
        $this->addSql('CREATE INDEX IDX_5147B67B7970CF8 ON face (artist_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__face_color AS SELECT color_id FROM face_color');
        $this->addSql('DROP TABLE face_color');
        $this->addSql('CREATE TABLE face_color (color_id VARCHAR(1) NOT NULL, card_id VARCHAR(36) NOT NULL COLLATE BINARY, face_index INTEGER NOT NULL, PRIMARY KEY(card_id, face_index, color_id))');
        $this->addSql('INSERT INTO face_color (color_id) SELECT color_id FROM __temp__face_color');
        $this->addSql('DROP TABLE __temp__face_color');
        $this->addSql('CREATE INDEX IDX_AE2D486A7ADA1FB5 ON face_color (color_id)');
