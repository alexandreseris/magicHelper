 ...
 */
final class Version20210327145419 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE face_manaCost (card_id VARCHAR(36) NOT NULL COLLATE BINARY, face_index INTEGER NOT NULL, symbol_id VARCHAR(20) NOT NULL COLLATE BINARY, PRIMARY KEY(card_id, face_index, symbol_id), CONSTRAINT FK_2855F4FE4ACC9A2048086782 FOREIGN KEY (card_id, face_index) REFERENCES face (card_id, "index") NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2855F4FEC0F75674 FOREIGN KEY (symbol_id) REFERENCES symbol (code) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__setOfCard AS SELECT code, name, released_date, setType_id FROM setOfCard');
        $this->addSql('DROP TABLE setOfCard');
        $this->addSql('CREATE TABLE setOfCard (code VARCHAR(10) NOT NULL COLLATE BINARY, name VARCHAR(100) NOT NULL COLLATE BINARY, released_date DATE DEFAULT NULL, setType_id VARCHAR(50) NOT NULL COLLATE BINARY, icon_url VARCHAR(255) NOT NULL, icon_local VARCHAR(255) DEFAULT NULL, PRIMARY KEY(code), CONSTRAINT FK_D01563FC5787671D FOREIGN KEY (setType_id) REFERENCES set_type (code) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO setOfCard (code, name, released_date, setType_id) SELECT code, name, released_date, setType_id FROM __temp__setOfCard');
        $this->addSql('DROP TABLE __temp__setOfCard');
        $this->addSql('CREATE INDEX IDX_D01563FC5787671D ON setOfCard (setType_id)');
        $this->addSql('ALTER TABLE symbol ADD COLUMN icon_local VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__setOfCard AS SELECT code, name, released_date, setType_id FROM setOfCard');
        $this->addSql('DROP TABLE setOfCard');
        $this->addSql('CREATE TABLE setOfCard (code VARCHAR(10) NOT NULL, name VARCHAR(100) NOT NULL, released_date DATE DEFAULT NULL, setType_id VARCHAR(50) NOT NULL, PRIMARY KEY(code))');
        $this->addSql('INSERT INTO setOfCard (code, name, released_date, setType_id) SELECT code, name, released_date, setType_id FROM __temp__setOfCard');
        $this->addSql('DROP TABLE __temp__setOfCard');
        $this->addSql('CREATE INDEX IDX_D01563FC5787671D ON setOfCard (setType_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__symbol AS SELECT code, name, is_funny, is_mana, icon_url, cmc FROM symbol');
        ...
        $this->addSql('INSERT INTO symbol (code, name, is_funny, is_mana, icon_url, cmc) SELECT code, name, is_funny, is_mana, icon_url, cmc FROM __temp__symbol');
