 ...
 */
final class Version20210329160125 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__face AS SELECT card_id, face_index, artist_id, image_url, name, type_line, oracle_text, printed_text, image_local FROM face');
        $this->addSql('DROP TABLE face');
        $this->addSql('CREATE TABLE face (card_id VARCHAR(36) NOT NULL COLLATE BINARY, face_index INTEGER NOT NULL, artist_id VARCHAR(255) DEFAULT NULL COLLATE BINARY, image_url VARCHAR(255) DEFAULT NULL COLLATE BINARY, name VARCHAR(255) NOT NULL COLLATE BINARY, type_line VARCHAR(100) NOT NULL COLLATE BINARY, oracle_text VARCHAR(2000) DEFAULT NULL COLLATE BINARY, printed_text VARCHAR(2000) DEFAULT NULL COLLATE BINARY, image_local VARCHAR(255) DEFAULT NULL COLLATE BINARY, power_value VARCHAR(5) DEFAULT NULL, toughness_value VARCHAR(5) DEFAULT NULL, PRIMARY KEY(card_id, face_index), CONSTRAINT FK_5147B674ACC9A20 FOREIGN KEY (card_id) REFERENCES card (id_scryfall) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5147B67B7970CF8 FOREIGN KEY (artist_id) REFERENCES artist (name) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO face (card_id, face_index, artist_id, image_url, name, type_line, oracle_text, printed_text, image_local) SELECT card_id, face_index, artist_id, image_url, name, type_line, oracle_text, printed_text, image_local FROM __temp__face');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_5147B674ACC9A20');
        $this->addSql('DROP INDEX IDX_5147B67B7970CF8');
        $this->addSql('CREATE TEMPORARY TABLE __temp__face AS SELECT face_index, card_id, artist_id, image_url, name, type_line, oracle_text, printed_text, image_local FROM face');
        $this->addSql('DROP TABLE face');
        $this->addSql('CREATE TABLE face (face_index INTEGER NOT NULL, card_id VARCHAR(36) NOT NULL, artist_id VARCHAR(255) DEFAULT NULL, image_url VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, type_line VARCHAR(100) NOT NULL, oracle_text VARCHAR(2000) DEFAULT NULL, printed_text VARCHAR(2000) DEFAULT NULL, image_local VARCHAR(255) DEFAULT NULL, power VARCHAR(5) DEFAULT NULL COLLATE BINARY, toughness VARCHAR(5) DEFAULT NULL COLLATE BINARY, PRIMARY KEY(card_id, face_index))');
        $this->addSql('INSERT INTO face (face_index, card_id, artist_id, image_url, name, type_line, oracle_text, printed_text, image_local) SELECT face_index, card_id, artist_id, image_url, name, type_line, oracle_text, printed_text, image_local FROM __temp__face');
        $this->addSql('DROP TABLE __temp__face');
        $this->addSql('CREATE INDEX IDX_5147B674ACC9A20 ON face (card_id)');
        $this->addSql('CREATE INDEX IDX_5147B67B7970CF8 ON face (artist_id)');
        $this->addSql('DROP INDEX IDX_AE2D486A4ACC9A2048086782');
