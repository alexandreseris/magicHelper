 ...
 */
final class Version20210426222142 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__card_producedMana AS SELECT card_id, symbol_id FROM card_producedMana');
        $this->addSql('DROP TABLE card_producedMana');
        $this->addSql('CREATE TABLE card_producedMana (card_id VARCHAR(36) NOT NULL COLLATE BINARY, symbol_id VARCHAR(20) NOT NULL COLLATE BINARY, PRIMARY KEY(card_id, symbol_id), CONSTRAINT FK_434A3D014ACC9A20 FOREIGN KEY (card_id) REFERENCES card (id_scryfall) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_434A3D01C0F75674 FOREIGN KEY (symbol_id) REFERENCES symbol (code) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO card_producedMana (card_id, symbol_id) SELECT card_id, symbol_id FROM __temp__card_producedMana');
        ...
        $this->addSql('DROP INDEX IDX_67066B3DC24CFB57');
        $this->addSql('DROP INDEX IDX_67066B3DD629F605');
        $this->addSql('DROP INDEX IDX_67066B3D4ACC9A20');
        $this->addSql('CREATE TEMPORARY TABLE __temp__card_legality AS SELECT card_id, format_id, legality_id FROM card_legality');
        $this->addSql('DROP TABLE card_legality');
        $this->addSql('CREATE TABLE card_legality (card_id VARCHAR(36) NOT NULL COLLATE BINARY, format_id VARCHAR(50) NOT NULL COLLATE BINARY, legality_id VARCHAR(50) NOT NULL COLLATE BINARY, PRIMARY KEY(card_id, format_id, legality_id), CONSTRAINT FK_67066B3D4ACC9A20 FOREIGN KEY (card_id) REFERENCES card (id_scryfall) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_67066B3DD629F605 FOREIGN KEY (format_id) REFERENCES format (code) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_67066B3DC24CFB57 FOREIGN KEY (legality_id) REFERENCES legality (code) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO card_legality (card_id, format_id, legality_id) SELECT card_id, format_id, legality_id FROM __temp__card_legality');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__face AS SELECT face_id, card_id, artist_id, face_index, image_url, name, type_line, oracle_text, printed_text, power_value, toughness_value, image_local FROM face');
        $this->addSql('DROP TABLE face');
        $this->addSql('CREATE TABLE face (face_id VARCHAR(40) NOT NULL COLLATE BINARY, card_id VARCHAR(36) NOT NULL COLLATE BINARY, artist_id VARCHAR(255) DEFAULT NULL COLLATE BINARY, face_index INTEGER NOT NULL, image_url VARCHAR(255) DEFAULT NULL COLLATE BINARY, name VARCHAR(255) NOT NULL COLLATE BINARY, type_line VARCHAR(100) NOT NULL COLLATE BINARY, oracle_text VARCHAR(2000) DEFAULT NULL COLLATE BINARY, printed_text VARCHAR(2000) DEFAULT NULL COLLATE BINARY, power_value VARCHAR(5) DEFAULT NULL COLLATE BINARY, toughness_value VARCHAR(5) DEFAULT NULL COLLATE BINARY, image_local VARCHAR(255) DEFAULT NULL COLLATE BINARY, PRIMARY KEY(face_id), CONSTRAINT FK_5147B674ACC9A20 FOREIGN KEY (card_id) REFERENCES card (id_scryfall) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5147B67B7970CF8 FOREIGN KEY (artist_id) REFERENCES artist (name) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO face (face_id, card_id, artist_id, face_index, image_url, name, type_line, oracle_text, printed_text, power_value, toughness_value, image_local) SELECT face_id, card_id, artist_id, face_index, image_url, name, type_line, oracle_text, printed_text, power_value, toughness_value, image_local FROM __temp__face');
        ...
        $this->addSql('DROP INDEX IDX_AE2D486AFDC86CD0');
        $this->addSql('CREATE TEMPORARY TABLE __temp__face_color AS SELECT face_id, color_id FROM face_color');
        $this->addSql('DROP TABLE face_color');
        $this->addSql('CREATE TABLE face_color (face_id VARCHAR(40) NOT NULL COLLATE BINARY, color_id VARCHAR(1) NOT NULL COLLATE BINARY, PRIMARY KEY(face_id, color_id), CONSTRAINT FK_AE2D486AFDC86CD0 FOREIGN KEY (face_id) REFERENCES face (face_id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_AE2D486A7ADA1FB5 FOREIGN KEY (color_id) REFERENCES color (code) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO face_color (face_id, color_id) SELECT face_id, color_id FROM __temp__face_color');
        ...
        $this->addSql('DROP INDEX IDX_6AFCD9AFC0F75674');
        $this->addSql('DROP INDEX IDX_6AFCD9AFFDC86CD0');
        $this->addSql('CREATE TEMPORARY TABLE __temp__face_mana_cost AS SELECT face_id, symbol_id, quantity FROM face_mana_cost');
        $this->addSql('DROP TABLE face_mana_cost');
        $this->addSql('CREATE TABLE face_mana_cost (face_id VARCHAR(40) NOT NULL COLLATE BINARY, symbol_id VARCHAR(20) NOT NULL COLLATE BINARY, quantity INTEGER NOT NULL, PRIMARY KEY(face_id, symbol_id), CONSTRAINT FK_6AFCD9AFFDC86CD0 FOREIGN KEY (face_id) REFERENCES face (face_id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6AFCD9AFC0F75674 FOREIGN KEY (symbol_id) REFERENCES symbol (code) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO face_mana_cost (face_id, symbol_id, quantity) SELECT face_id, symbol_id, quantity FROM __temp__face_mana_cost');
        $this->addSql('DROP TABLE __temp__face_mana_cost');
        ...
        $this->addSql('CREATE TABLE setOfCard (code VARCHAR(10) NOT NULL COLLATE BINARY, name VARCHAR(100) NOT NULL COLLATE BINARY, released_date DATE DEFAULT NULL, icon_url VARCHAR(255) NOT NULL COLLATE BINARY, icon_local VARCHAR(255) DEFAULT NULL COLLATE BINARY, setType_id VARCHAR(50) NOT NULL COLLATE BINARY, PRIMARY KEY(code), CONSTRAINT FK_D01563FC5787671D FOREIGN KEY (setType_id) REFERENCES set_type (code) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('ALTER TABLE symbol ADD COLUMN index_value INTEGER DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__setOfCard');
        $this->addSql('CREATE INDEX IDX_D01563FC5787671D ON setOfCard (setType_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__symbol AS SELECT code, name, is_funny, is_mana, icon_url, cmc, icon_local, code_variant FROM symbol');
        ...
        $this->addSql('INSERT INTO symbol (code, name, is_funny, is_mana, icon_url, cmc, icon_local, code_variant) SELECT code, name, is_funny, is_mana, icon_url, cmc, icon_local, code_variant FROM __temp__symbol');
